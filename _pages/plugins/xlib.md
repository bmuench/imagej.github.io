...
{% include thumbnail src='/media/plugins/xfig6-15-cow.jpg' title='Cow on Swiss alps (left), its wavelet decomposition at decomposition level 2 by using the Haar wavelet when providing a nice view (top center) and a reconstructible format (bottom center), and finally, its reconstruction (right).'%}
